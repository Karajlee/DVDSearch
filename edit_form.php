<?php
	...
	$row_dvd_title = $results->fetch_assoc();
...
<body>
	...
	<div class="container">
		...
		<form action="edit_confirmation.php" method="POST">
			...
			<input type="hidden" name="dvd_title_id" value="<?php echo $row_dvd_title['dvd_title_id']; ?>">

			<div class="form-group row">
				<label for="title-id" class="col-sm-3 col-form-label text-sm-right">Title: <span class="text-danger">*</span></label>
				<div class="col-sm-9">
					<input type="text" class="form-control" id="title-id" name="title" value="<?php echo $row_dvd_title['title']; ?>">
				</div>
			</div> <!-- .form-group -->
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<input type="date" class="form-control" id="release-date-id" name="release_date" value="<?php echo $row_dvd_title['release_date']; ?>">
				</div>
			</div> <!-- .form-group -->
				...
				<div class="col-sm-9">
					<select name="label" id="label-id" class="form-control">
						...
						<?php while( $row = $results_labels->fetch_assoc() ): ?>
							...
							<?php if ( $row['label_id'] == $row_dvd_title['label_id'] ) : ?>
				...
				<div class="col-sm-9">
					<select name="sound" id="sound-id" class="form-control">
						...
						<?php while( $row = $results_sounds->fetch_assoc() ): ?>
							...
							<?php if ( $row['sound_id'] == $row_dvd_title['sound_id'] ) : ?>
				...
				<div class="col-sm-9">
					<select name="genre" id="genre-id" class="form-control">
						...
						<?php while( $row = $results_genres->fetch_assoc() ): ?>
							...
							<?php if ( $row['genre_id'] == $row_dvd_title['genre_id'] ) : ?>
				...
				<div class="col-sm-9">
					<select name="rating" id="rating-id" class="form-control">
						...
						<?php while( $row = $results_ratings->fetch_assoc() ): ?>
							...
							<?php if ( $row['rating_id'] == $row_dvd_title['rating_id'] ) : ?>
				...
				<div class="col-sm-9">
					<select name="format" id="format-id" class="form-control">
						...
						<?php while( $row = $results_formats->fetch_assoc() ): ?>
							...
							<?php if ( $row['format_id'] == $row_dvd_title['format_id'] ) : ?>
